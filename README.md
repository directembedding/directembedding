...
With DirectEmbedding, there is not special difficulty for the identification, it does the hard task of *pattern matching* the ASTs and using the macros, the solution is elegant and proposes only one reification logic. **Pretty simple!**
